...
- [`ToolOutputLimits`](tool-output-limits.md): bounds how much context any single tool result can consume, spilling oversized results to this machine's temporary directory so no workspace is needed

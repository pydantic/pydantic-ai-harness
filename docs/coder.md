...
See the [source](https://github.com/pydantic/pydantic-ai-harness/tree/main/pydantic_ai_harness/agents/coder/).

## API reference

::: pydantic_ai_harness.agents.coder.Coder

::: pydantic_ai_harness.agents.coder.coder_agent

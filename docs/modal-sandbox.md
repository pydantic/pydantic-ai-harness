---
title: Modal Sandbox
description: "Run a Pydantic AI agent's shell commands and file edits in an isolated Modal cloud sandbox instead of on your host, continuing in the same sandbox across runs."
---

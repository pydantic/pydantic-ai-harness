...
| [Logfire MCP](logfire-mcp.md) | Harness | Query Logfire telemetry and manage dashboards, alerts, and issues through the hosted MCP server; changes need approval, and `read_only=True` hides them |

...
| [Prompt Injection Defender](prompt-injection-defender.md) | Classifies tool results for indirect prompt injection using [defender](https://github.com/StackOneHQ/defender-py) by StackOne, and can withhold high-risk results. | `stackone-defender` |

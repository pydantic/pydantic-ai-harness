...
| [Prompt Injection Defender](prompt-injection-defender.md) | Scans tool results for indirect prompt injection using [defender](https://github.com/StackOneHQ/defender-py) by StackOne: sanitizes risky fields and can withhold high-risk results. | `stackone-defender` |

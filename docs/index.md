...
| [Logfire MCP](logfire-mcp.md) | Harness | Query Logfire telemetry through the hosted MCP server, read-only by default; opt in to manage dashboards, alerts, and issues |

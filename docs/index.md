...
| [Haunt Extraction](haunt.md) | Read supported web pages as Markdown or extract specific fields as JSON through the [Haunt](https://hauntapi.com/) API, with typed page-level failures. | -- |

...
| [Prompt Injection Defender](prompt-injection-defender.md) | Classifies local tool results for indirect prompt injection and can withhold high-risk results. | `prompt-injection-defender` |

---
title: Retry Policy
description: Retries transient tool failures (rate limits, timeouts, provider errors) with exponential backoff; a tool is retried only when you mark it idempotent.
---
...
See the [source](https://github.com/pydantic/pydantic-ai-harness/tree/main/pydantic_ai_harness/retry_policy/).

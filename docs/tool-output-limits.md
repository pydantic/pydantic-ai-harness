...
agent = Agent('anthropic:claude-sonnet-5', capabilities=[LocalWorkspace('.'), ToolOutputLimits()])
```
...
same role by implementing [`FileReader`](filesystem.md#reading-files-other-capabilities-keep).

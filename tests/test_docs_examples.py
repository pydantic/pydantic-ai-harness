...
def test_daytona_durable_example_is_module_level_and_runnable() -> None:
    root = Path(__file__).parent.parent
    for path in (root / 'docs/daytona-sandbox.md', root / 'pydantic_ai_harness/daytona_sandbox/README.md'):

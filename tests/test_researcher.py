...
from pydantic_ai_harness.agents.researcher import DEFAULT_RESEARCHER_INSTRUCTIONS, Researcher, researcher_agent
...
def test_researcher_unknown_export() -> None:
    import pydantic_ai_harness.agents.researcher

    with pytest.raises(AttributeError, match='has no attribute'):
        pydantic_ai_harness.agents.researcher.__getattr__('missing')

"""Frame data for the cli-spinners-style builtins in `spinners`, ported verbatim from Code Puppy's `puppy_spinner`.

Data only, with non-ASCII characters escape-spelled so the source stays ASCII. Intervals are absent:
`spinners` applies one speed to every entry here.
"""

# Rows are packed several per line to keep the file short; the bare marker must stay bare.
# fmt: off
EXTRA_SPECS: dict[str, tuple[tuple[str, ...], str]] = {
    'dotsWide': (
        (
            '\u2809\u2809', '\u2808\u2819', '\u2800\u2839', '\u2800\u28b8', '\u2800\u28f0',
            '\u2880\u28e0', '\u28c0\u28c0', '\u28c4\u2840', '\u28c6\u2800', '\u2847\u2800',

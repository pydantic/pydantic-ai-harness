...
capabilities to the summary call itself: capabilities on the outer agent do not run on it, so this
is the seam for summary hooks and policies, not for tools.

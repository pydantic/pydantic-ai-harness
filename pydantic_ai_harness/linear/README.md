...
> the [version policy](https://github.com/pydantic/pydantic-ai-harness#version-policy).
...
mutations, compose the resulting toolset with Pydantic AI's [tool approval](https://ai.pydantic.dev/toolsets/#requiring-tool-approval).

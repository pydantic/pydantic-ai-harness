...
start with an error that says how to attach one. Commands start in the
workspace's working directory; to run them in a subdirectory, set it on the
workspace (`LocalWorkspace('./repo')`). See

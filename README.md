...
| [Retry Policy](pydantic_ai_harness/retry_policy/) | Harness | Retry transient tool failures (rate limits, timeouts, provider errors) with exponential backoff; only tools you mark idempotent are retried |

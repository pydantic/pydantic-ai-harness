...
| | **Command-aware tool access control** | Allow/ask/deny rules plus shell-command safety analysis (compound commands, wrapper stripping, a read-only safelist, a flag denylist) and an identity/RBAC decision channel | :white_check_mark: [Docs](pydantic_ai_harness/permission_policy/) | [pydantic-ai-shields](https://github.com/vstorm-co/pydantic-ai-shields) (vstorm&#8209;co) |

...
| | **Prompt injection defense** | Classify local tool results for indirect prompt injection and optionally withhold high-risk results | :white_check_mark: [Docs](pydantic_ai_harness/prompt_injection_defender/) | [defender-py](https://github.com/StackOneHQ/defender-py) |

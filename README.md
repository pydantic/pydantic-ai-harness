...
|---|---|---|
| [Structured Output](pydantic_ai_harness/structured_output/) | Harness | Return a JSON Schema-shaped value the model is made to satisfy, with retries naming each violation |

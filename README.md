...
| | **Fresh verification** | Redirect completion attempts when checks are stale after the latest code edit | :white_check_mark: [Docs](pydantic_ai_harness/require_verification/) | |

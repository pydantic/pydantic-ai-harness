...
| | **Audit log** | Structured records of tool calls and run outcomes to a pluggable sink, with optional redaction -- for audit, cost attribution, and eval datasets | :white_check_mark: [Docs](pydantic_ai_harness/audit_log/) | |

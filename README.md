...
| | **Confined authoring** | Let an agent author its own typed, sandboxed, persistent tools -- default-deny injected-function allowlist | :white_check_mark: [Docs](pydantic_ai_harness/experimental/confined_authoring/) (experimental) | |

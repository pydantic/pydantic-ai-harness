...
| | **Prompt injection defense** | Scan tool results for indirect prompt injection with a batteries-included detector: sanitize risky fields, optionally block high-risk results, using [defender](https://github.com/StackOneHQ/defender-py) by StackOne | :white_check_mark: [Docs](pydantic_ai_harness/prompt_injection_defender/) | [defender-py](https://github.com/StackOneHQ/defender-py) (StackOne) |

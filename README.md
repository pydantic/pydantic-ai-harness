...
| [Logfire MCP](pydantic_ai_harness/logfire_mcp/) | Harness | Query Logfire telemetry and manage dashboards, alerts, and issues through the hosted MCP server; changes need approval, and `read_only=True` hides them |

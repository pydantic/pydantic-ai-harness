...
| [Logfire MCP](pydantic_ai_harness/logfire_mcp/) | Harness | Query Logfire telemetry through the hosted MCP server, read-only by default; opt in to manage dashboards, alerts, and issues |

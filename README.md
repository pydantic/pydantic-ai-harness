...
| | **Web extraction** | Read public pages as Markdown or extract plain-English-described fields as JSON, backed by [Haunt](https://hauntapi.com/?utm_source=pydantic-ai-harness&utm_medium=integration&utm_campaign=sweep-2026-07). Blocked, login-walled, captcha-guarded, or missing pages return typed error codes. | :white_check_mark: [Docs](pydantic_ai_harness/haunt/) | |
